...
(function() {
  var date_range, find_templates, format_date, getCookie, months, number_postfix, summarize, templates, time_range,
    __slice = [].slice;
    ...
    get_events = function(position) {
      ...
      return $.ajax({
        ...
        success: function(data) {
          var date_str, end_time, row, start_time, _i, _len, _ref;
          target.empty();
          _ref = data.results;
